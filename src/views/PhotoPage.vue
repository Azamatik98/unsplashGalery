...
import { getPhotoId } from '../api/PhotoApi'
            ...
            <div class="photo">
                <div class="photo__header">
                    <div class="photo-author">
                        <img :src="photo?.user?.profile_image?.medium" class="photo-author__avatar"
                    ...
                    <div class="photo-header__right">
                        ...
                        <a :href="photo?.links?.html" :download="photo?.links?.html" class="btn photo-header__download"
                            target="_blank">
                            <i>
                                <IconDownload />
                            </i>
